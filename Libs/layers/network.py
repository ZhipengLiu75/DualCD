...
class Network(nn.Module):
    def __init__(self, seq_len, pred_len, patch_len, stride, padding_patch,enc_in,num_classes):
        ...
        self.fc9 = nn.Linear(pred_len * enc_in, 128)
    ...
    def forward(self, s, t):
        ...
        x = self.fc8(x)
        x = torch.reshape(x, (B, -1)) # [Batch, Channel, Output]
        x=self.fc9(x)
        return x